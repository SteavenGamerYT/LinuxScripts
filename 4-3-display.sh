...
echo "Checking if the Xrandr commands exist in .profile"
...
xrandr --addmode DVI-I-0 "1440x900_60.00"' ~/.profile; then
    echo "Display Hack Script is already installed."
else
...
xrandr --addmode DVI-I-0 "1440x900_60.00"' | sudo tee -a ~/.profile
    echo "Display Hack Script has been added to .profile."
fi
